...
public class ModelAndBlockStatesProvider extends BlockStateProvider {
    ...
    public void quarryBlock(QuarryBlock block) {
        ModelFile quarryOff = models().withExistingParent(block.getRegistryName().toString() + "_off", new ResourceLocation(Quarry.MOD_ID, "generation/quarry_block")).texture("1", new ResourceLocation(Quarry.MOD_ID, "block/quarry_block_off")).texture("2", new ResourceLocation(Quarry.MOD_ID, "block/quarry_block_side")).texture("3", new ResourceLocation(Quarry.MOD_ID, "block/quarry_block_top")).texture("particle", new ResourceLocation(Quarry.MOD_ID, "block/quarry_block_side"));
        ModelFile quarryIdle = models().withExistingParent(block.getRegistryName().toString() + "_idle", new ResourceLocation(Quarry.MOD_ID, "generation/quarry_block")).texture("1", new ResourceLocation(Quarry.MOD_ID, "block/quarry_block_idle")).texture("2", new ResourceLocation(Quarry.MOD_ID, "block/quarry_block_side")).texture("3", new ResourceLocation(Quarry.MOD_ID, "block/quarry_block_top")).texture("particle", new ResourceLocation(Quarry.MOD_ID, "block/quarry_block_side"));
        ModelFile quarryOn = models().withExistingParent(block.getRegistryName().toString() + "_on", new ResourceLocation(Quarry.MOD_ID, "generation/quarry_block")).texture("1", new ResourceLocation(Quarry.MOD_ID, "block/quarry_block_on")).texture("2", new ResourceLocation(Quarry.MOD_ID, "block/quarry_block_side")).texture("3", new ResourceLocation(Quarry.MOD_ID, "block/quarry_block_top")).texture("particle", new ResourceLocation(Quarry.MOD_ID, "block/quarry_block_side"));
        ModelFile quarryWorking = models().withExistingParent(block.getRegistryName().toString() + "_work", new ResourceLocation(Quarry.MOD_ID, "generation/quarry_block")).texture("1", new ResourceLocation(Quarry.MOD_ID, "block/quarry_block_work")).texture("2", new ResourceLocation(Quarry.MOD_ID, "block/quarry_block_side")).texture("3", new ResourceLocation(Quarry.MOD_ID, "block/quarry_block_top")).texture("particle", new ResourceLocation(Quarry.MOD_ID, "block/quarry_block_side"));
