...
public class AreaCardScreen extends BaseScreen<AreaCardContainer> {
    ...
    protected void renderLabels(@NotNull PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (stack.getOrCreateTag().getInt("Selection") == 0) {
            drawText(new TranslatableComponent("item.quarry.areacard.text.pos_1").getString(), pPoseStack, 34, 20);
            drawText(new TranslatableComponent("item.quarry.areacard.text.pos_2").getString(), pPoseStack, 118, 20);
            drawText(new TextComponent("X").getString(), pPoseStack, 9, 35);
            drawText(new TextComponent("Y").getString(), pPoseStack, 9, 52);
            drawText(new TextComponent("Z").getString(), pPoseStack, 9, 69);
            drawText(new TextComponent("X").getString(), pPoseStack, 184, 35);
            drawText(new TextComponent("Y").getString(), pPoseStack, 184, 52);
            drawText(new TextComponent("Z").getString(), pPoseStack, 184, 69);
            if (!init1) {
        ...
        if (stack.getOrCreateTag().getInt("Selection") == 2) {
            ...
            drawText(new TranslatableComponent("item.quarry.areacard.text.framing").getString(), pPoseStack, 18, 23);
        ...
        // Main Text
        drawText(new TranslatableComponent("item.quarry.areacard.text.pos").getString(), pPoseStack, 33, 6);
        drawText(new TranslatableComponent("item.quarry.areacard.text.radius").getString(), pPoseStack, 84, 6);
        drawText(new TranslatableComponent("item.quarry.areacard.text.chunk").getString(), pPoseStack, 140, 6);
        drawText(new TranslatableComponent("item.quarry.areacard.text.save").getString(), pPoseStack, 88, 91);
        drawText(new TranslatableComponent("item.quarry.areacard.text.filter").getString(), pPoseStack, 87, 108);
